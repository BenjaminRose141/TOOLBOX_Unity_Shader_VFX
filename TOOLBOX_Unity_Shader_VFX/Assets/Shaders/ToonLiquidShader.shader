//SHADER BY https://gist.github.com/josephbk117/0ae30f1e4593a82fb6b6c27d620cddc3

Shader "Custom/ToonLiquidShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
		    Zwrite On  //pixels are written to depth buffer
